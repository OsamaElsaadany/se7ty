...
import 'package:se7ty/features/patient/search/widgets/item_tile.dart';
import 'package:se7ty/features/patient/search/widgets/phone_tile.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                "نبذه تعريفية",
                style: TextStyles.styleSize18.copyWith(fontWeight: FontWeight.bold),
              ),
              const SizedBox(height: 10),
              Text(widget.doctorModel?.bio ?? '', style: TextStyles.styleSize14),
              const SizedBox(height: 20),
              Container(
