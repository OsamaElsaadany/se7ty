...
import 'package:se7ty/features/auth/models/specializations.dart';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'التخصص',
                    style: TextStyles.styleSize16.copyWith(color: appcolor.darkcolor),
                  ),
                  const Gap(10),
                  // التخصص---------------
                  Container(
                  ...
                  if (cubit.specialization == null && isShowError)
                    Text(
                      'من فضلك اختر التخصص',
                      style: TextStyles.styleSize16.copyWith(color: Colors.red),
                    ),
                  const Gap(15),
                  Text(
                    'نبذة تعريفية',
